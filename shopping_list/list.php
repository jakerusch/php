...
$getList = "SELECT master_list.item_id, master_list.title, master_list.sort_order, list_content.checked_status, list_content.qty
	FROM list_content
	JOIN master_list
...
while($row=$result->fetch_assoc()) {
	if($row["checked_status"]==1) {
		...
		echo "<li class=\"list-group-item\" id=\"".$row['item_id']."\"><span class=\"glyphicon glyphicon-unchecked\"></span> ".$row['title']." x <b>".$row['qty']."</b><span class=\"glyphicon glyphicon-trash pull-right\"></span></li>";
	}
}
